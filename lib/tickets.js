...
async function sendTicketEmail(ticket) {
  ...
  <div style="background:#000000;padding:0;font-family:Arial,Helvetica,sans-serif;color:#fff;">
    <div style="max-width:460px;margin:0 auto;">
      ...
      <!-- brand stripe -->
      <div style="height:8px;background:linear-gradient(90deg,#FF2800 0%,#FF2800 25%,#FFC700 25%,#FFC700 50%,#E8291C 50%,#E8291C 75%,#0a0a0a 75%,#0a0a0a 100%);"></div>
      ...
      <div style="background:#0a0a0a;padding:34px 26px;text-align:center;">
        ...
        <div style="display:inline-block; background:${isFree ? '#FFC700' : '#FF2800'}; color:#000; font-weight:800; font-size:11px; letter-spacing:2px; text-transform:uppercase; padding:8px 16px; margin-bottom:20px; transform:skewX(-6deg);">
          ${isFree ? 'Lista gratis · antes de 12am' : 'Entrada pagada · S/45'}
        </div>
        ...
        <div style="background:#fff;display:inline-block;padding:14px;border:3px solid #FF2800;margin-bottom:18px;">
        ...
        <div style="border-top:1px solid #2a2a2a;padding-top:18px;font-size:12px;color:#bbb;line-height:1.7;text-align:left;">
          ...
          ${isFree ? ' Válido solo hasta las 12:00 am — después aplica el cover de S/45.' : ' Válido toda la noche.'}
        </div>
      </div>

      <div style="height:8px;background:linear-gradient(90deg,#0a0a0a 0%,#0a0a0a 25%,#E8291C 25%,#E8291C 50%,#FFC700 50%,#FFC700 75%,#FF2800 75%,#FF2800 100%);"></div>

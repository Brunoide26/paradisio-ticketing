...
async function createTicket({ name, phone, email, dni, dob, type, amount, docType, orderId }) {
...
module.exports = {
  ...
  buildTicketEmailHtml, buildTicketEmailText, tierValidityLabel, tierTypeLabel, entradaUrl, ordenUrl,
};

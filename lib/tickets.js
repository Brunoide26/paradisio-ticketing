  ...
  <div style="background:#090909;padding:32px 16px;font-family:Arial,Helvetica,sans-serif;color:#F2EDE4;">
    <div style="max-width:460px;margin:0 auto;">
      ...
      <div style="background:#141414;padding:36px 28px;text-align:center;">
        ...
        <p style="margin:0 0 6px;font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:#FF2800;font-weight:700;">${typeLabel}</p>
  ...
  <div style="background:#090909;padding:32px 16px;font-family:Arial,Helvetica,sans-serif;color:#F2EDE4;">
    <div style="max-width:460px;margin:0 auto;">
      ...
      <div style="background:#141414;padding:36px 28px;text-align:center;">
        ...
        <p style="margin:0 0 24px;font-size:20px;font-weight:800;color:#F2EDE4;">${order.qty} entrada${order.qty > 1 ? 's' : ''} ${skuLabel}</p>

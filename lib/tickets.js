  ...
  <div style="background:#090909;padding:32px 16px;font-family:Arial,Helvetica,sans-serif;color:#F2EDE4;">
    <div style="max-width:460px;margin:0 auto;">
      ...
      <div style="background:#141414;padding:36px 28px;text-align:center;">
        ...
        <p style="margin:0 0 26px;font-size:12px;color:#888880;">Este código QR es válido para un solo ingreso.</p>
...
module.exports = {
  redis, FREE_CAP, PAID_CAP, EVENT_NAME, EVENT_DATE_LABEL, CONTACT_EMAIL, EMAIL_SUBJECT,
  ...
  buildTicketEmailHtml, buildTicketEmailText,
};
